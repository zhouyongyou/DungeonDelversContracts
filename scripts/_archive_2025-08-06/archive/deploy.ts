...
async function main() {
    ...
    // ★ 修改：為 deployedContracts 增加更多資訊，以供驗證使用
    ...
    await (await (deployedContracts.DungeonStorage.instance as any).setLogicContract(await dm.getAddress())).wait();
    await (await (deployedContracts.Hero.instance as any).setDungeonCore(await dc.getAddress())).wait();
    ...
    await (await (deployedContracts.Relic.instance as any).setDungeonCore(await dc.getAddress())).wait();
    ...
    await (await (deployedContracts.Party.instance as any).setDungeonCore(await dc.getAddress())).wait();
    ...
    await (await (deployedContracts.PlayerVault.instance as any).setDungeonCore(await dc.getAddress())).wait();
    ...
    // ★★★★★【修正結束】★★★★★
    await (await (deployedContracts.AltarOfAscension.instance as any).setDungeonCore(await dc.getAddress())).wait();
    await (await dm.setDungeonCore(await dc.getAddress())).wait();
    await (await dm.setDungeonStorage(deployedContracts.DungeonStorage.address)).wait();
    await (await (deployedContracts.VIPStaking.instance as any).setDungeonCore(await dc.getAddress())).wait();
    ...
    await (await (deployedContracts.PlayerProfile.instance as any).setDungeonCore(await dc.getAddress())).wait();
