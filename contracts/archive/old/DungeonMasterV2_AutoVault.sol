// contracts/DungeonMasterV2_AutoVault.sol (自動金庫記帳版本)
...
contract DungeonMasterV2_AutoVault is Ownable, ReentrancyGuard, Pausable {
    ...
    // --- 獎勵領取函數（已棄用）---
    // ★★★ 注意：由於獎勵直接存入 PlayerVault，這個函數不再需要 ★★★
