 ...
 * 4. 改進錯誤處理和事件記錄
 */
contract VRFConsumerV2Plus_Optimized is VRFConsumerBaseV2Plus {
    ...
    uint32 public callbackGasLimit = 250000;  // ⚡ 從 500000 優化到 250000（足夠且節省成本）
    uint16 public requestConfirmations = 3;
    uint32 public numWords = 1;
    
    // Gas 限制範圍（防止設置錯誤值）
    uint32 public constant MIN_CALLBACK_GAS_LIMIT = 100000;
    uint32 public constant MAX_CALLBACK_GAS_LIMIT = 500000;
