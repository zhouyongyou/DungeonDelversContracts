// DungeonMaster_final.sol - 最終統一版本（混合權限模式）
...
contract DungeonMaster_Final is Ownable, ReentrancyGuard, Pausable, IVRFCallback {
    ...
    function cleanupExpiredRequest(address user) external {
        ...
        require(request.timestamp > 0, "No timestamp");
        ...
        require(
            ...
            block.timestamp > request.timestamp + REQUEST_TIMEOUT * 2, // 1小時後公開
        ...
        // Refund if payment was made (Pull Payment)
