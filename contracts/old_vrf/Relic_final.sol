...
contract Relic_Final is ERC721, Ownable, ReentrancyGuard, Pausable, IVRFCallback {
    ...
    function cleanupExpiredRequest(address user) external {
        ...
        require(
            ...
            block.timestamp > requestTimestamp[user] + REQUEST_TIMEOUT * 2, // 1小時後公開
        ...
        // Clear request and record refund (Pull Payment)
        MintRequest storage request = userRequests[user];
