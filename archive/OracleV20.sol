...
contract OracleV20 is Ownable {
    ...
    constructor(
        ...
        require(_token0 == soulShardToken || _token0 == usdToken, "Oracle: Pool tokens mismatch");
        require(_token1 == soulShardToken || _token1 == usdToken, "Oracle: Pool tokens mismatch");
    ...
    /**
     * @notice 公開函數：獲取 SoulShard token 地址
     */
